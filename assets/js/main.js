...
let check_out_fun = () => {
    ...
    check_out.innerHTML = `
        <div class="checkout">
            <p>Subtotal: $<span id="subtotal">${total_amount.toFixed(2)}</span></p>
            <div class="promo-code">
                <input type="text" id="promo-input" placeholder="Enter promo code">
                <button onclick="applyPromoCode()">Apply</button>
            </div>
            <p id="discount-text">Discount: $<span id="discount">0.00</span></p>
            <p>Total: $<span id="total">${total_amount.toFixed(2)}</span></p>

            <p id="promo-message"></p>
        </div>
    `;

    // Set global subtotal variable
    window.subtotal = total_amount;
};
